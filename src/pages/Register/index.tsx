      ...
      <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md text-center">
          <div className="bg-surface rounded-lg border border-border p-8">
            ...
            <h2 className="text-sm font-medium text-primary mb-2">Conta criada!</h2>
            <p className="text-xs text-secondary mb-6 leading-relaxed">
              Enviamos um e-mail de verificação para você. Confirme seu e-mail antes de fazer login.
            </p>
            <Link to="/login">
    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-sm font-medium text-primary">Criar Conta</h1>
          <p className="text-xs text-secondary mt-2">Cadastre-se para acessar a plataforma</p>
        </div>
        ...
        <div className="bg-surface rounded-lg border border-border p-6">
          ...
          <p className="text-center text-xs text-muted mt-6">
            Já tem conta?{' '}
            <Link to="/login" className="text-secondary hover:text-primary transition-colors underline underline-offset-4">
              Entrar
            </Link>
          </p>
        </div>
